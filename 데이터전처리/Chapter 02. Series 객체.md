...
* 생성자의 dtype 매개변수를 사용하면 강제로 다른 유형으로 변환할 수 있다.
...
* 브로드 캐스팅이라는 용어는 청취하는 모든 수신자에게 동일한 신호를 전송하는 라디오 방송 타워에서 유래했습니다. s1 + 3은 Series의 각 값에 동일한 연산을 적용하세요 를 의미합니다.
