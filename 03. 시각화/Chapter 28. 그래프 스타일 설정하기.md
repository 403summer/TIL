# Chapter 28. 그래프 스타일 설정하기

![28-1](image/28/28-1.png)

## 01. 기본 사용

![28-2](image/28/28-2.png)
...
[matplotlib.style](https://matplotlib.org/stable/api/style_api.html) 모듈은 미리 만들어놓은 Matplotlib 그래프 스타일을 포함하고 있습니다.
...
![28-7](image/28/28-7.png)

더 많은 rcParams은 아래의 리스트를 참고하세요.
