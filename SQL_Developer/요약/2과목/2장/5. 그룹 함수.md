...
ACCOUNTING PRESIDENT    1         5000 
 RESEARCH   CLERK       2         1900 9개의 행이 선택되었다.
...
SALES      CLERK        1           950  
SALES      MANAGER      1          2850 
SALES      SALESMAN     4          5600 9개의 행이 선택되었다.
```
...
FROM EMP, DEPT 
WHERE DEPT.DEPTNO = EMP.DEPTNO 
GROUP BY ROLLUP (DNAME, (JOB, MGR)); ☞ JOB, MGR을 소계시 하나의 집합으로 간주하여 구분하지 않음
```
